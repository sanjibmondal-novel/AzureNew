...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AzureNew", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<AzureNewContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "AzureNew API v1");
